    ...
    <header>
        ...
        <nav id="main-nav" class="mobile-offcanvas navbar-left align-menu mt-5 gap-5 ">
            ...
            <ul class="align-menu gap-5 mt-4 ms-5">
                ...
                <li class="top-nav-item "><a class="top-nav-link" href="index.php" aria-disabled="true">Home</a></li>
        ...
        <div>
            ...
            <section class="row mb-4">
                ...
                <section class="col-mb pt-5 ">
                    ...
                    <img  class="m-auto me-5 img-fluid img-45" id="preview" src="./imgs/placeholder.png" alt="Preview">
