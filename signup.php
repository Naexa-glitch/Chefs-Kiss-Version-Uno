...
<div class="wrapper">
    ...
    <form class="form-signin" action="response-signup.php" method="post">
            ...
            <input class="mr-3 btn btn-danger btn-lg btn-block" type="submit" value="Sign up">
 
            </div>
            <div class="mt-2">
        <a href="login.php" class="text-gray mt-2">Already have an account? <span> Login </span></a>
            </div>
    </form>
</div>
